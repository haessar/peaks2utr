...
class TestNoStrandOverlap(unittest.TestCase):
    def setUp(self):
        ...
        self.args.max_distance = 2000

    def tearDown(self):
        os.remove(os.path.join(TEST_DIR, "Chr1.db"))

    def _do_annotation(self, expected_annotations):
    ...
    def test_utr_with_overlap(self):
        self.args.no_strand_overlap = False
        expected_annotations = {
